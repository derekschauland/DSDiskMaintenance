<#	
	===========================================================================
	 ...
	 Created by:   	derek
	 Organization: 	
	 Filename:     	dsdiskmaintenance.psd1
	 -------------------------------------------------------------------------
	 Module Manifest
	-------------------------------------------------------------------------
...
@{
	...
	ModuleToProcess = 'dsdiskmaintenance.psm1'
	
	# Version number of this module.
	ModuleVersion = '1.0.0.0'
	
	# ID used to uniquely identify this module
	GUID = '6d82edd5-97ce-49c9-a8a2-42a6b7f82f43'
	...
	Description = 'A module full of functions to help keep disks clean'
